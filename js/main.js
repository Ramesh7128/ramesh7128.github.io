$(document).ready(function() {
    ...
    //------- Filter  js --------//
      ...
      $('.filters-menu li').click(function(){
        ...
        var dataMenu = $(this).attr('data-filter-menu');
        $gridMenu.isotope({
          filter: dataMenu
        })
      });
      ...
      if(document.getElementById("menu")) {
        var $gridMenu = $(".grid-menu").isotope({
          filter: '.combos',
          itemSelector: ".all",
    ...
    $('.filters-gallery li').click(function(){
        $('.filters-gallery li').removeClass('active');
        $(this).addClass('active');
        
        var dataGallery = $(this).attr('data-filter-gallery');
        $gridGallery.isotope({
          filter: dataGallery
        })
    });
      ...
      if(document.getElementById("gallery")) {
        var $gridGallery = $(".grid-gallery").isotope({
            itemSelector: ".all",
            percentPosition: true,
            masonry: {
            columnWidth: ".all"
    ...
    // initially set to 100 by defualt.
